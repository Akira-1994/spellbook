...
CREATE TABLE spell_entries(
    ...
    pdf_page_start INTEGER NOT NULL CHECK(pdf_page_start BETWEEN 192 AND 1162),
    pdf_page_end INTEGER NOT NULL CHECK(pdf_page_end BETWEEN pdf_page_start AND 1162),
